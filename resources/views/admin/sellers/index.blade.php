    ...
    <script>
        $(document).ready(function () {
            var DataTable = $("#example1").DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: `{{route('sellers.index')}}`,    //redirect with ajax on specific route 
                },
                columns: [
            ...
            $(document).on('click','#ok_delete',function(){
                $.ajax({
                    url:`{{url('admin/sellers/destroy')}}/${delete_id}`,
                    type:'post',
                    data:{
                        id:delete_id,
                        "_method": 'DELETE',
                    ...
                    success: function (data) {
                        ...
                        //   js_success(data);
                        if(data==0) {
                            toastr.error('Exception Here ! Delete Firstly Sellers Added Products');
                        }else{
