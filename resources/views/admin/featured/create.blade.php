                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Featured Ad Form</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Featured Ad Form</h3>
                            </div>
                            <form class="category-form" method="post" action="{{ route('featuredAds.store') }}"
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="banner" id="banner_file"
                                                    onchange="PreviewImage('banner_file','banner')" required
