...
@section('title', 'Special Deal Packages')
@section('page_css')
    <!-- Datatables -->
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Special Deal Packages</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Special Deal Packages</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            {{-- <div class="card-header">
                                <a class="btn btn-primary addBtn" href="{{ route('featuredAds.create') }}">Add Featured
                                    Ad</a>
                            </div> --}}
                            <!-- /.card-header -->
                            <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            var DataTable = $("#example1").DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: `{{ route('specialDealPackage.index') }}`,
                },
                columns: [{
                        "data": 'DT_RowIndex',
                        orderable: false,
            ...
            $(document).on('click', '#status-switch', function() {
                ...
                $.ajax({
                    type: "get",
                    url: `{{ url('admin/' . request()->segment(2) . '/changeFeaturedAdStatus') }}/${id}`,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    data: {
