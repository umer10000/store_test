        ...
        <section class="content">
            <div class="row">
                ...
                <div class="card card-outline card-info">
                    ...
                    <!-- /.card-header -->
                    <form class="category-form" method="post" action="{{ route('terms-and-conditions-update', ['id' => $id]) }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="CmsComponent_id" value="{{ $CmsComponent->id }}">
                    <div class="card-body">
                        <textarea id="summernote" name="description">{{ $CmsComponent->description  }}</textarea>
                    </div>
