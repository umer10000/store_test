                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Second Section Component</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Second Section Component</h3>
                            </div><br>
                            <div class="col-md-12 text-right">
                                <button class="btn btn-sm btn-success" id="add_more">Add More</button>
                            </div>
                            <form class="category-form" method="post"
                                action="{{ route('second-section-component-store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    @if (Session::has('msg'))
                                        <div class="alert alert-success">{{ Session::get('msg') }}</div>
                                    @endif
                                    <input type="hidden" name="cms_pages_id" id="cms_pages_id" value="{{ $cmsSection->id }}">
